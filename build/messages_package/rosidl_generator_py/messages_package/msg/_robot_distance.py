...
class Metaclass_RobotDistance(type):
    """Metaclass of message 'RobotDistance'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'messages_package.msg.RobotDistance')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__robot_distance
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__robot_distance
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__robot_distance
            cls._TYPE_SUPPORT = module.type_support_msg__msg__robot_distance
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__robot_distance
...
class RobotDistance(metaclass=Metaclass_RobotDistance):
    """Message class 'RobotDistance'."""
    ...
    def robot_distance(self):
        """Message field 'robot_distance'."""
        return self._robot_distance

    @robot_distance.setter
    def robot_distance(self, value):
        if __debug__:
            assert \
