...
{
  new (message_memory) messages_package::msg::Item(_init);
}

void Item_fini_function(void * message_memory)
{
  auto typed_message = static_cast<messages_package::msg::Item *>(message_memory);
  typed_message->~Item();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Item_message_member_array[4] = {
  {
    "name",  // name
    ...
    offsetof(messages_package::msg::Item, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(messages_package::msg::Item, age),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(messages_package::msg::Item, location),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(messages_package::msg::Item, quantity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Item_message_members = {
  ...
  "Item",  // message name
  4,  // number of fields
  sizeof(messages_package::msg::Item),
...
{
  return &::messages_package::msg::rosidl_typesupport_introspection_cpp::Item_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages_package, msg, Item)() {
  return &::messages_package::msg::rosidl_typesupport_introspection_cpp::Item_message_type_support_handle;
}
