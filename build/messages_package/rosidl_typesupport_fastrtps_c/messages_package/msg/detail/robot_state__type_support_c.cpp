...
#include "messages_package/msg/detail/robot_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // robot_state
#include "rosidl_runtime_c/string_functions.h"  // robot_state

// forward declare type support functions


using _RobotState__ros_msg_type = messages_package__msg__RobotState;
...
size_t get_serialized_size_messages_package__msg__RobotState(
  const void * untyped_ros_message,
...
static uint32_t _RobotState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_messages_package__msg__RobotState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages_package
size_t max_serialized_size_messages_package__msg__RobotState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_messages_package__msg__RobotState(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_package, msg, RobotState)() {
