...
#include "messages_package/msg/detail/coordinates__rosidl_typesupport_fastrtps_c.h"
...
using _Coordinates__ros_msg_type = messages_package__msg__Coordinates;
...
static uint32_t _Coordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_messages_package__msg__Coordinates(
...
{
  return max_serialized_size_messages_package__msg__Coordinates(
    full_bounded, 0);
}
