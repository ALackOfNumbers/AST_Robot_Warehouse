...
#ifndef MESSAGES_PACKAGE__SRV__DETAIL__PICK_UP_ITEM__FUNCTIONS_H_
#define MESSAGES_PACKAGE__SRV__DETAIL__PICK_UP_ITEM__FUNCTIONS_H_
...
/// Initialize srv/PickUpItem message.
/**
...
/// Finalize srv/PickUpItem message.
/**
...
/// Create srv/PickUpItem message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * messages_package__srv__PickUpItem_Request__init().
...
/// Destroy srv/PickUpItem message.
/**
 * It calls
 * messages_package__srv__PickUpItem_Request__fini()
...
/// Initialize array of srv/PickUpItem messages.
/**
...
/// Finalize array of srv/PickUpItem messages.
/**
 * It calls
 * messages_package__srv__PickUpItem_Request__fini()
...
/// Create array of srv/PickUpItem messages.
/**
 * It allocates the memory for the array and calls
 * messages_package__srv__PickUpItem_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PickUpItem messages.
/**
 * It calls
 * messages_package__srv__PickUpItem_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * messages_package__srv__PickUpItem_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_messages_package
...
/**
 * It calls
 * messages_package__srv__PickUpItem_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_messages_package
...
/**
 * It allocates the memory for the array and calls
 * messages_package__srv__PickUpItem_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_messages_package
...
/**
 * It calls
 * messages_package__srv__PickUpItem_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MESSAGES_PACKAGE__SRV__DETAIL__PICK_UP_ITEM__FUNCTIONS_H_
