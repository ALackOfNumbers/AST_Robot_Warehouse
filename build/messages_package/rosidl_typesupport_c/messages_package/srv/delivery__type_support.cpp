...
static const _Delivery_Request_type_support_symbol_names_t _Delivery_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_package, srv, Delivery_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, messages_package, srv, Delivery_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, messages_package, srv, Delivery_Request)() {
  return &::messages_package::srv::rosidl_typesupport_c::Delivery_Request_message_type_support_handle;
}
...
static const _Delivery_Response_type_support_symbol_names_t _Delivery_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_package, srv, Delivery_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, messages_package, srv, Delivery_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_messages_package
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, messages_package, srv, Delivery_Response)() {
  return &::messages_package::srv::rosidl_typesupport_c::Delivery_Response_message_type_support_handle;
}
...
static const _Delivery_type_support_symbol_names_t _Delivery_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_package, srv, Delivery)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, messages_package, srv, Delivery)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, messages_package, srv, Delivery)() {
  return &::messages_package::srv::rosidl_typesupport_c::Delivery_service_type_support_handle;
}
