...
#ifndef MESSAGES_PACKAGE__MSG__DETAIL__ROBOT_STATE__FUNCTIONS_H_
#define MESSAGES_PACKAGE__MSG__DETAIL__ROBOT_STATE__FUNCTIONS_H_
 ...
 * calls
 * messages_package__msg__RobotState__init().
...
/**
 * It calls
 * messages_package__msg__RobotState__fini()
 ...
 * messages_package__msg__RobotState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * messages_package__msg__RobotState__Sequence__fini()
 * on the array,
...
#endif  // MESSAGES_PACKAGE__MSG__DETAIL__ROBOT_STATE__FUNCTIONS_H_
