...
bool messages_package__msg__item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("messages_package.msg._item.Item", full_classname_dest, 31) == 0);
  }
  messages_package__msg__Item * ros_message = _ros_message;
  {  // name
...
PyObject * messages_package__msg__item__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("messages_package.msg._item");
