    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'messages_package.msg.RobotLocation')
            logger.debug(
...
class RobotLocation(metaclass=Metaclass_RobotLocation):
    ...
    _fields_and_field_types = {
        'robot_number': 'int64',
        'robot_location': 'messages_package/Coordinates',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from messages_package.msg import Coordinates
        self.robot_location = kwargs.get('robot_location', Coordinates())
    ...
    def __eq__(self, other):
        ...
        if self.robot_number != other.robot_number:
            return False
        if self.robot_location != other.robot_location:
            return False
        return True
    ...
    def robot_location(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'robot_location' field must be a sub message of type 'Coordinates'"
